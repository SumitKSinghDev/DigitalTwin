    ...
    <div className={`relative ${className} flex items-center justify-center`}>
      {glow && (
        <div className={`absolute inset-0 rounded-full pointer-events-none transition-all duration-300 ${
          isLight 
            ? 'bg-indigo-500/5 blur-sm shadow-[0_2px_8px_rgba(99,102,241,0.12)]' 
            : 'logo-glow blur-md'
        }`} />
      )}
      <svg
      ...
      >
        ...
        <circle cx="50" cy="50" r="42" stroke="url(#logoGrad)" strokeWidth="1.2" strokeDasharray="3 5" opacity={isLight ? "0.2" : "0.35"} />
        ...
        <polygon points="50,28 69,39 69,61 50,72 31,61 31,39" stroke="url(#logoGrad)" strokeWidth="1" strokeLinejoin="round" strokeDasharray="2 3" opacity={isLight ? "0.4" : "0.6"} />
        
        {/* Symmetric coordinate connection axes */}
        <line x1="50" y1="16" x2="50" y2="84" stroke="url(#logoGrad)" strokeWidth="0.8" strokeDasharray="4 4" opacity={isLight ? "0.25" : "0.5"} />
        <line x1="21" y1="32" x2="79" y2="68" stroke="url(#logoGrad)" strokeWidth="0.8" strokeDasharray="4 4" opacity={isLight ? "0.25" : "0.5"} />
        <line x1="21" y1="68" x2="79" y2="32" stroke="url(#logoGrad)" strokeWidth="0.8" strokeDasharray="4 4" opacity={isLight ? "0.25" : "0.5"} />
        ...
        <circle cx="79" cy="68" r="3.5" fill={isLight ? "#8b5cf6" : "#ec4899"} className="logo-node" strokeWidth="1.5" />
        ...
        <circle cx="21" cy="32" r="3.5" fill={isLight ? "#6366f1" : "#ec4899"} className="logo-node" strokeWidth="1.5" />
      </svg>
    </div>
  );
};
